...
"This program initials three database columns for dataset videos"

==input==
video_path : the path of dataset videos

==output==
DATASET_VIDEO0 : video_name COLUMN
DATASET_VIDEO1 : frame_id COLUMN
DATASET_VIDEO2 : frame_feature COLUMN
...
def main():
    print("[Info] Start dataset video column initial!")
    ...
    f = open(col_path + "/video_name.txt",'w')
    for i in range(len(video_name) - 1):
