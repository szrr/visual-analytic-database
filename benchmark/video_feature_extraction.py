...
def get_box_from_file(target_string, file_path="boxes.txt"):
...
def main():
   ...
   # obtain pretrained parameters
    ...
    with open("search_videos.txt", 'r') as f:
        lines = f.readlines()
        video_name = lines[int(video_index)].strip()
    path = "/home/szr/subquery/gtvideos/" + video_name
    ...
    while vidcap.isOpened():
        ...
        if i > frame_skip - 1:
            ...
            box = get_box_from_file(video_name)
            print("box =", box)
